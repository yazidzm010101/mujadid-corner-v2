    ...
    <>
      <nav className="w-full max-w-screen-xl h-12 fixed z-[999] top-12 left-0 flex items-center px-10">
        <button className="ms-auto">
          <img
            src={navButton.src}
            className="w-10 relative aspect-square object-contain hover:brightness-200"
          />
        </button>
      ...
      <Eclipse
        className={
          "pointer-events-none fixed top-0 right-0 translate-x-1/2 -translate-y-1/2  w-[150vw] md:w-[185vw] opacity-10"
        }
      />
    </>
  );
